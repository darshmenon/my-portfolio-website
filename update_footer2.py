#!/usr/bin/env python3
"""
Script to update footer: add second X account and remove icons
"""

import re
import os

# New footer HTML content without icons and with both X accounts
...
def main():
    ...
    print("\n✓ All pages updated - added second X account and removed icons!")
